...
MACH_SYSCALL(_kernelrpc_mach_vm_allocate, 4, 10, todo)
MACH_ERROR_SYSCALL(11)
MACH_SYSCALL(_kernelrpc_mach_vm_deallocate, 3, 12, todo)
MACH_ERROR_SYSCALL(13)
MACH_SYSCALL(_kernelrpc_mach_vm_protect, 5, 14, todo)
MACH_SYSCALL(_kernelrpc_mach_vm_map, 6, 15, todo)
MACH_SYSCALL(_kernelrpc_mach_port_allocate, 3, 16, todo)
MACH_SYSCALL(_kernelrpc_mach_port_destroy, 2, 17, todo)
MACH_SYSCALL(_kernelrpc_mach_port_deallocate, 2, 18, todo)
MACH_SYSCALL(_kernelrpc_mach_port_mod_refs, 4, 19, todo)
...
MACH_SYSCALL(mach_reply_port, 0, 26, todo)
MACH_SYSCALL(thread_self, 0, 27, todo)
MACH_SYSCALL(task_self, 0, 28, todo)
MACH_SYSCALL(host_self, 0, 29, todo)
MACH_ERROR_SYSCALL(30)
MACH_SYSCALL(mach_msg, 7, 31, todo)
...
MACH_SYSCALL(mach_timebase_info, 1, 89, todo)
