UNIX_SYSCALL(syscall, 0, syscall)
...
UNIX_SYSCALL(mkdir, 136, passthrough)
...
UNIX_SYSCALL(lseek, 199, passthrough)
...
UNIX_SYSCALL(iopolicysys, 322, passthrough)
...
UNIX_SYSCALL(proc_info, 336, passthrough)
...
UNIX_SYSCALL(statfs64, 345, passthrough)
...
UNIX_SYSCALL(getaudit_addr, 357, passthrough)
