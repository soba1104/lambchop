...
UNIX_SYSCALL(read, 3, todo)
UNIX_SYSCALL(write, 4, todo)
UNIX_SYSCALL(open, 5, todo)
UNIX_SYSCALL(close, 6, todo)
...
UNIX_SYSCALL(pipe, 42, todo)
UNIX_SYSCALL(getegid, 43, todo)
UNIX_OLD_SYSCALL(profil, 44)
UNIX_OLD_SYSCALL(ktrace, 45)
UNIX_SYSCALL(sigaction, 46, todo)
UNIX_SYSCALL(getgid, 47, todo)
...
UNIX_SYSCALL(munmap, 73, todo)
UNIX_SYSCALL(mprotect, 74, todo)
UNIX_SYSCALL(madvise, 75, todo)
...
UNIX_SYSCALL(bind, 104, todo)
UNIX_SYSCALL(setsockopt, 105, todo)
UNIX_SYSCALL(listen, 106, todo)
...
UNIX_SYSCALL(getattrlist, 220, todo)
...
UNIX_SYSCALL(psynch_mutexwait, 301, todo)
UNIX_SYSCALL(psynch_mutexdrop, 302, todo)
UNIX_SYSCALL(psynch_cvbroad, 303, todo)
UNIX_SYSCALL(psynch_cvsignal, 304, todo)
UNIX_SYSCALL(psynch_cvwait, 305, todo)
...
UNIX_SYSCALL(stat64, 338, todo)
UNIX_SYSCALL(fstat64, 339, todo)
UNIX_SYSCALL(lstat64, 340, todo)
UNIX_SYSCALL(stat64_extended, 341, todo)
UNIX_SYSCALL(lstat64_extended, 342, todo)
UNIX_SYSCALL(fstat64_extended, 343, todo)
UNIX_SYSCALL(getdirentries64, 344, todo)
UNIX_SYSCALL(statfs64, 345, todo)
UNIX_SYSCALL(fstatfs64, 346, todo)
...
UNIX_SYSCALL(bsdthread_create, 360, todo)
...
UNIX_SYSCALL(bsdthread_register, 366, todo)
...
UNIX_SYSCALL(thread_selfid, 372, todo)
...
UNIX_SYSCALL(read_nocancel, 396, todo)
UNIX_SYSCALL(write_nocancel, 397, todo)
UNIX_SYSCALL(open_nocancel, 398, todo)
UNIX_SYSCALL(close_nocancel, 399, todo)
...
UNIX_SYSCALL(bsdthread_ctl, 478, todo)
